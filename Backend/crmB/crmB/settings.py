"""
Django settings for crmB project.
...
WSGI_APPLICATION = "crmB.wsgi.application"
...
# Optionnel : Personnalisation des durées de validité
SIMPLE_JWT = {
