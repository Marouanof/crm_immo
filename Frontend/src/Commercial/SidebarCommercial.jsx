...
import { FaChevronDown, FaGlobe, FaHome, FaUser, FaBuilding, FaUserPlus, FaSignOutAlt } from "react-icons/fa";
...
const SidebarCommercial = () => {
  ...
  return (
    <div className="d-flex min-vh-100 ">
      {/* Sidebar */}
      <div
        className="bg-sidebar sidebar p-4 shadow-lg rounded-5 m-3 "
