...
export default function ActionMenu({ onEdit, onAssociate,  onDelete }) {
    ...
    <div className="menu-container" ref={menuRef}>
      ...
      {open && (
        ...
        >
          ...
          <div className="menu-item" onClick={onAssociate}>Associer à un lead</div>
          {/* <div className="menu-item" onClick={onInfo}>Voir plus</div> */}
